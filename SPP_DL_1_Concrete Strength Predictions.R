#Building an ANN Neural Network Model to predict the strength of the concrete.
...
conc.df <- read.csv("D:\\001_Data\\Not Completed\\Concrete data set\\concrete.csv")
head(conc.df)
tail(conc.df)
dim(conc.df)
summary(conc.df)
